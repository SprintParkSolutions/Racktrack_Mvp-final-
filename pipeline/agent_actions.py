...
TEMPLATES = {
    ...
    ("port_down", "access"): "Walk to {rack} {u_str}, verify cable on port {port} of {device}; "
    ...
    ("port_down", "*"): "Walk to {rack} {u_str}, verify cable on port {port} of {device}; "
    "check LED, reseat both ends.",
    # ── Cable issues ─────────────────────────────────────────────────────
    ("cable_swap", "*"): "Walk to {rack} {u_str}, replace patch cable on port {port} of {device}. "
    "After swap, clear interface counters and observe for 15 min.",
    ("flapping", "*"): "Walk to {rack} {u_str}, inspect port {port} of {device} for loose RJ45 "
    "or worn cable. Reseat or replace; monitor for re-flap.",
    # ── Slow link / errors ───────────────────────────────────────────────
    ("slow_link", "*"): "Walk to {rack} {u_str}, inspect cable on port {port} of {device} for "
    "kinks/EMI exposure. Verify autoneg / duplex on both ends.",
    ("crc_errors", "*"): "Walk to {rack} {u_str}, replace patch cable on port {port} of {device}. "
    ...
    # ── Hardware replace ─────────────────────────────────────────────────
    ("hardware_replace", "*"): "Walk to {rack} {u_str}, replace failed component on {device}. "
